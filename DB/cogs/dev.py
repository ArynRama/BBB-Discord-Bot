...
class Dev(commands.Cog):
    ...
    async def cog(self, ctx: bridge.BridgeContext, subcommand:Union[discord.Option(str, "Subcommand you want to execute", default = "None", choices= ["load", "unload", "reload", "add"]), str]= "None", cog = "None"):
